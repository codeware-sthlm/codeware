...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "payload"."enum_footer_variant" AS ENUM('compact', 'standard', 'expanded');
  ...
  ALTER TABLE "payload"."site_settings" ADD COLUMN "footer_variant" "payload"."enum_footer_variant" DEFAULT 'standard';
  ALTER TABLE "payload"."site_settings" ADD COLUMN "footer_link_source" "payload"."enum_footer_link_source" DEFAULT 'navigation';
  ALTER TABLE "payload"."site_settings" ADD COLUMN "footer_show_copyright" boolean DEFAULT true;
