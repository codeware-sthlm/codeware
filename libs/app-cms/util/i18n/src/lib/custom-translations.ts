...
You can assign multiple tags to a file.`,
    ...
    platform: {
      ...
      integrationsAllConfigured: 'Email, error tracking and storage all set up',
      ...
      integrationsMetric: '{{count}} of 3 set up',
...
Du kan tilldela flera etiketter till en fil.`,
    ...
    platform: {
      ...
      integrationsAllConfigured:
        'E-post, felrapportering och lagring är uppsatta',
      integrationsEmailMissing:
      ...
      integrationsMetric: '{{count}} av 3 uppsatta',
      integrationsNotProduction:
