...
/** Link shades outside this range are either invisible or indistinguishable from body text. */
  ...
  return (
    <div className="bg-background text-foreground flex h-screen overflow-hidden">
          ...
          <div className="space-y-5 p-4">
            ...
            <div className="space-y-2">
              ...
              <p className="text-muted-foreground text-[11px]">
                Drives every surface, border and neutral text.
              </p>
              <div className="flex flex-wrap gap-1.5">
            ...
            <Sheet>
              ...
              <SheetContent
                side="left"
                className="flex w-[32rem] max-w-[90vw] flex-col gap-4 p-4"
              >
                <SheetHeader className="p-0">
                  <SheetTitle>Fine-tune tokens</SheetTitle>
                  <SheetDescription>
                    An edited token stops following the recipe, so changing the
                    brand or base later leaves it behind.
                  </SheetDescription>
                </SheetHeader>
                <OverridePanel
                  generated={generated}
      ...
      <main className="flex min-w-0 flex-1 flex-col">
        <header className="border-border flex h-12 shrink-0 items-center justify-between border-b px-5">
          <Tabs
            value={scheme}
            onValueChange={(value) =>
...
/** Re-exported so a host can offer the same shade list the studio does. */
export { COLOR_SHADES };
