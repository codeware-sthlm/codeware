 ...
 *
 * Links are resolved to plain paths, so the renderer stays free of Payload
 * document shapes. The navigation tree is the link source unless the editor
 * has picked custom links or turned links off.
 *
