...
Visit [`@cdwr/nx-payload`](https://github.com/codeware-sthlm/cdwr/tree/main/packages/nx-payload/README.md) for instructions how to use the plugin and the application it generates.
